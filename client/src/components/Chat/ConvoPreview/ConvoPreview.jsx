...
const ConvoPreview = ({ conversation }) => {
  // CONVERSION OF TIME TO READABLE FORMAT FROM MONGODB
  ...
  // FLAGS FOR EACH SPECIFIC LANGUAGE
  ...
  if (
    ...
    conversation.partnerLanguage === 'PT-BR' ||
    conversation.partnerLanguage === 'PT-PT'
  ) {
    displayLang = 'PT';
  } else {
